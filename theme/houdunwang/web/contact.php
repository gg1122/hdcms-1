...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{{ARTICLE_URL}}/css/contactus.css?version={{HDCMS_VERSION}}" />
						...
						<dl>
							...
							<dd>
								<table>
									...
									<tr><td><strong>宿舍配置：</strong></td><td><strong>2-6人间，中央空调、宽带、独立卫生间、洗衣机(公用)、洗澡间(公用)（如需其他生活用品费用自理）</strong></td></tr>
