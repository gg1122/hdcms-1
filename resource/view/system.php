...
<head>
    ...
    <link rel="stylesheet" href="/resource/css/hdcms.css">
    ...
    <link href="{{root_url()}}/resource/css/hdcms.css" rel="stylesheet">
    <script>
...
<div hd-cloak="">
    ...
    <div class="container-fluid  system-container">
        ...
        <div class="text-muted footer">
            ...
            Powered by hdcms {{$cloud['version']}} Build: {{$cloud['build']}} © 2014-2019 www.hdcms.com
